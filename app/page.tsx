...
const skills = ["Moodle Administration", "LMS Operations", "Moodle Web Services", "Workflow Automation", "PHP & MySQL", "Data & Reporting", "Next.js & TypeScript", "GitHub & Deployment"];
    ...
    <main>
      ...
      <section className="hero shell">
        <div>
          ...
          <div className="actions"><a className="btn primary" href="#work">Explore my work ↘</a><a className="btn" href="https://www.linkedin.com/in/eltonmalumbot/" target="_blank" rel="noreferrer">LinkedIn ↗</a></div>
        </div>
        <div className="hero-side">
          ...
          <aside className="hero-card">
            ...
            <div className="stats"><div><b>3</b><span>Core LMS projects</span></div><div><b>5</b><span>Case studies</span></div><div><b>API</b><span>Moodle Web Services</span></div><div><b>Ops</b><span>Production workflows</span></div></div>
          </aside>
        </div>
      </section>

      <section id="work" className="section shell">
        <div className="section-head"><div><p className="eyebrow">SELECTED WORK</p><h2>Systems built around real operational problems.</h2></div><p className="muted note">The first three projects focus directly on Moodle and LMS operations.</p></div>
